...
const Album: FC<Props> = (props) => {
  ...
  return (
    <div onClick={() => props.onClick(props.album)} className="album">
      <div className="album-thumbnail" style={{ backgroundImage: thumbUrl }}></div>
      <span title={props.album.title} className="album-title">
        {props.album.title}
      </span>
    </div>
  );
